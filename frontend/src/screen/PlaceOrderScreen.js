...
//   useEffect(() => {
//     if (!cart.shippingAddressFromStorage.address) {
//       navigate('/shipping');
//     } else if (!cart.paymentMethod) {
//       navigate('/payment');
//     }
//   }, [cart.paymentMethod, cart.shippingAddressFromStorage.address, navigate]);
  ...
  const placeOrderHandler = async () => {
    try {
      dispatch(createOrder({
        ...
        shippingAddressFromStorage: cart.shippingAddressFromStorage,
